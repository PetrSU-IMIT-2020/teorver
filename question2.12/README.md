...
> > $ \xi(\omega) $, определенная на множестве элементарных исходов 
> > $\Omega $ - **случайная величина**, если для любого действительного числа 
> > $x $ множество тех 
> > $\omega $, для которых 
> > $\xi(\omega) < x $, является событием и принадлежит 
> > $\sigma $-алгебре.*
>
